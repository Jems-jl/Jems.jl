...
=#
n=3
StellarModels.n_polytrope_initial_condition!(n, sm, 0.70,0.0,0.0002,Chem.abundance_lists[:ASG_09],MSUN, 100 * RSUN; initial_dt=10 * SECYEAR)
...
StellarModels.n_polytrope_initial_condition!(n, sm, 0.7,0.0,0.0002,Chem.abundance_lists[:ASG_09],MSUN, 100 * RSUN; initial_dt=10 * SECYEAR)
