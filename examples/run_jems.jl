...
=#
n = 3
StellarModels.pms_initial_condition!(n, sm, nz, 0.7154, 0.0142, 0.0, Chem.abundance_lists[:ASG_09], MSUN,
...
#StellarModels.n_polytrope_initial_condition!(n, sm, nz, 0.7154, 0.0142, 0.0, Chem.abundance_lists[:ASG_09], 
    #                                        5 * MSUN, 1000 * RSUN; initial_dt=0.1 * SECYEAR)

pms_initial_condition!(sm, nz, 0.7154, 0.0142, 0.0, Chem.abundance_lists[:ASG_09], 5 * MSUN, 1000 * RSUN; initial_dt=0.1 * SECYEAR, log(0.18), log(2.65e7))
