...
=#
n = 3
StellarModels.n_polytrope_initial_condition!(n, sm, nz, 0.7154,0.0142,0.0003,Chem.abundance_lists[:ASG_09],MSUN, 100 * RSUN; initial_dt=10 * SECYEAR)
...
BenchmarkTools.save("BM1_Kipp_6ISO_A.json", a)
...
BenchmarkTools.save("BM1_Kipp_6ISO_B.json", b)
