...
errorbars!(log10.(x_values), log10.(y_values_B), y_errors_B, color=:darkorange, linewidth=3, whiskerwidth=10)
...
save("BM_VaryingIsotopes_Kipp_15_to_50.png", f)

# Intercept A: 4.395836352203541
# Slope A: 2.3140012129831296
# Error on Intercept A: 0.09270830470271409
# Error on Slope A: 0.05697403349184767
# Intercept B: 4.655071721517739
# Slope B: 2.2725071973635687
# Error on Intercept B: 0.06074428038176088
# Error on Slope B: 0.03778053132249795