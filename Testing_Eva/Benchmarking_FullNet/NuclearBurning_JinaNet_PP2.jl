...
513.786036 seconds (144.44 M allocations: 9.531 GiB, 0.42% gc time, 3.19% compilation time: <1% of which was recompilation)

Reached maximum model number
500.679426 seconds (144.44 M allocations: 9.531 GiB, 0.42% gc time, 3.26% compilation time)
