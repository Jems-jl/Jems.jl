...
net = NuclearNetwork([:H1, :D2, :T3, :He3, :He4,
                      :Be7, :Li7, :B8
                      # :C12,   :C13,   
                      # :N13,   :N14,   :N15,
                      # :O14,   :O15,   :O16,   :O17,   :O18,   
...
oz.props.ind_vars[oz.network.xa_index[:H1]] = 0.9
oz.props.ind_vars[oz.network.xa_index[:D2]] = 0.1
...
lines!(ax, history[!, "age"], log10.(history[!, "T3"]), label=L"^3T")
