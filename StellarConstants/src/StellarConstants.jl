...
const KEV = 8.617385e-5                  # converts temp to ev (ev K^-1)
...
const CRAD = BOLTZ_SIGMA*4/CLIGHT        # = radiation density constant, a (erg cm^-3 K^-4); Prad = crad * T^4 / 3
                                   # approx = 7.5657e-15
const WEINLAM = PLANCK_H*CLIGHT/(KERG * 4.965114232e0)
const WEINFRE = 2.821439372E0*KERG/PLANCK_H
