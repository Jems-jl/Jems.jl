...
function build_properties_for_equation_set(equation_set::DefaultStellarEquationSet, nvars, nz, nextra, network, vari, number_type, internal_dual_tag)
...
function build_solver_data_for_equation_set(equation_set::AbstractEquationSet, nvars, nz, nextra, use_static_arrays, number_type, internal_dual_tag)
    return ThomasSolverData(nvars, nz, nextra, use_static_arrays, number_type, internal_dual_tag)
end
