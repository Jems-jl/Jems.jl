...
Uses a Newton-Raphson solver to find the precise logarithm of Temperature (`lnT`) that produces 
a target Pressure (`P`) for a known density (`lnρ`) and composition, querying the actual Equation of State.
"""
